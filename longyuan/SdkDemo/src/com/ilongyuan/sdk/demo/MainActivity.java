package com.ilongyuan.sdk.demo;
...
import com.longyuan.sdkdemo.tools.http.AccessTokenModel;
import com.longyuan.sdkdemo.tools.http.HttpUtil;
import com.longyuan.sdkdemo.tools.http.Json;
import com.longyuan.sdkdemo.tools.http.NetException;
import com.longyuan.sdkdemo.tools.http.RespModel;
import com.longyuan.sdkdemo.tools.http.SdkJsonReqHandler;
import com.longyuan.sdk.release.R;
...
//								Log.d("gst", "token-->"+token);
								IlongSDK.getInstance().setUserToken(MainActivity.this, token,
										new IToken2UserInfo() {
