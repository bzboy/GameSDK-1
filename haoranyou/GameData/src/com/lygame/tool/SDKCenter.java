...
public class SDKCenter extends Gamer{
	...
	public void Send() {
		...
		Waiting_Queue_Signal = new ArrayList<String>();
		sendData(sending_Queue_Signal, mActivity,DataType.SDK);
	}
	...
	public  void paymentSuccess(String AccoutId,String orderId,String iapId,String amount,String currencyType,String
			paymentType){
		try{
		PaymentSuccess paySuccess = new PaymentSuccess(AccoutId, orderId, iapId, amount, currencyType, paymentType, Gamer.getTime());
		String queueItem = JSON.toJSONString(paySuccess);
