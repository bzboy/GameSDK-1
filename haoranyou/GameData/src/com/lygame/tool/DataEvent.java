...
//	public static final String META_CHANNEL = "ChannelID";
	public static final String META_APPID = "GAME_APPID";
	public static final int platform = 1;
	/**这里修改为了 浩然游的SDK的统计appid值：wzMIyIwUuZIM1ap7mEJHNxm6KjaezDgZ*/
	public static final String SDK_APPID = "wzMIyIwUuZIM1ap7mEJHNxm6KjaezDgZ";
	...
	public static String getSignal(ArrayList<String> sinalcomplex,DataType type) {
		if(type == DataType.SDK){
			postDateModel.setAppId(SDK_APPID);
