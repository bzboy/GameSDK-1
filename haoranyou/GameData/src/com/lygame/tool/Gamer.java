...
import com.lygame.model.coin.PaymentSuccess;
...
import com.lygame.tool.HttpHelper.MHttp;
/**
 * 上传信息类
 * @author 邹龙
 *
...
//	public static String ServerID = "";
	...
	public static String mChannel = "hr";
...
//		Waiting_Queue_Signal = new ArrayList<String>();
	...
	public static void sendData(ArrayList<String> data, Context context,DataType type){
		...
		Logd.d(Tag, origData);
		String sendingData = mSecret.encryptcbc(origData);
		sendingData = "data=" + sendingData + "&origData=" + origData;
		sendingData = sendingData.replaceAll("[+]", "%2B");
		NetWork.getInstance(sendingData, Constant.URL_ADD_BASE64,new HttpResponseHandler(type)).start();
		if(Constant.isDebug){
...
//	}
	...
	public abstract void paymentSuccess(String AccoutId,String orderId,String iapId,String amount,String currencyType,String
			paymentType);
}